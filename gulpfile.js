...
function watch (done) {
  gulp.watch(paths.scripts.src, gulp.series(scripts.copyModules, scripts.bundle, browserSync.reload));
...
gulp.task('build',
  gulp.series(
    clean,
    gulp.parallel(assets, styles, scripts.copyModules, scripts.bundle, images, metalsmith.build)
  )
);
